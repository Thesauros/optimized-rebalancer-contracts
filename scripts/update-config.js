...
async function main() {
  ...
  if (!targetNetwork) {
    console.log('Usage: node scripts/update-config.js <network>');
...
async function updateHardhatConfig(networkKey, network) {
...
async function updateEnvFile(networkKey, network) {
...
async function updatePackageScripts(networkKey) {
